...
INSERT INTO `books2` VALUES (0,1,'The Shining',1),(1,2,'It',1),(2,3,'The Great Gatsby',2),(3,4,'The Call of the Wild',3),(4,5,'Pride and Prejudice',4),(5,6,'Frankenstein',5);
/*!40000 ALTER TABLE `books2` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `favorites_books`
--

DROP TABLE IF EXISTS `favorites_books`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `favorites_books` (
  ...
  KEY `ix_favorites_books_index` (`index`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `favorites_books`
--

LOCK TABLES `favorites_books` WRITE;
/*!40000 ALTER TABLE `favorites_books` DISABLE KEYS */;
INSERT INTO `favorites_books` VALUES (0,1,1),(1,1,2),(2,1,3),(3,2,4),(4,2,5),(5,3,5),(6,3,6);
/*!40000 ALTER TABLE `favorites_books` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-08 21:53:59
